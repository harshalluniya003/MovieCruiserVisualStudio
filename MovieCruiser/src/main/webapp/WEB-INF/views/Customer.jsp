...
<body>
	<div id="section1">
		<header>
			<nav>
				...
				<div class="start">
					<a href="car"><span>Favourites</span></a>
				</div>
			</nav>
		</header>
	</div>
	...
	<div>
		<h3>
			<font color="red">${Movie_Added}</font>
		</h3>
	</div>
				...
				<div class="pic-1">
					...
					<div class="description">
						<div class="top">
							...
							<div class="description-1">
								<p>Rs. ${item.boxoffice}</p>
							</div>
						</div>
						<div class="bottom">
							<div class="description-2">
								<p>${item.active}<span>${item.genre}</span>
								</p>
							</div>
							<div class="description-2">
								<p>
									<i class='fas fa-truck' style='font-size: 24px'></i><span></span>
								</p>
							</div>
							<div class="atc-container">
								<a href="cart?menu_id=${item.movieId}">
