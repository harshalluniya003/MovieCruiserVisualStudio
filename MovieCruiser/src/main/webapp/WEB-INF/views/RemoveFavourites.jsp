...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
<title>Favourites Notification</title>
</head>
				...
				<div class="mdl-grid">
					...
					<div class="mdl-cell--6-col">
						<table class="mdl-data-table mdl-js-data-table">
							<caption>
								<h3>Favourites</h3>
								<p class="notif">Movie Removed From Favourites Successfully</p>
							</caption>
							<br>
							<br>
							<thead>
							...
							<tbody id="customer-table">
								<tr>
									...
									<td><a href="RemoveFavourites.html">Delete</a></td>
								</tr>
								<tr>
									<td>The Avengers</td>
									<td>$1,518,812,988</td>
